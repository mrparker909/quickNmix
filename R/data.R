...
#' 
#' @references Parker, M.R.P., Pattison, V. & Cowen, L.L.E. Estimating population abundance using counts from an auxiliary population. Environ Ecol Stat 27, 509–526 (2020). \url{https://doi.org/10.1007/s10651-020-00455-3}
#'
...
#'
#' @description Golden Eagle counts for the years 1993 to 2020, collected by the Rocky Mountain Eagle Research Foundation (RMERF). Counts are made during the spring from April 1st until March 22nd each year. Data is available from \url{https://eaglewatch.ca}.
#' 
#' @references Rocky Mountain Eagle Research Foundation (RMERF). EagleWatch.ca. (2020). \url{https://eaglewatch.ca}.
#'
